...
| Agent | 目的 |
|---|---|
| 初見の読者 | 予備知識なしで、理解、期待、興味、引っかかりを一人称で返す |
| 感覚を読む読者 | 感情、身体感覚、空気、温度、リズム、余韻としてどう届いたかを返す |
| 構造編集者 | 主題、構造、論理、反論、反対視点、暗黙の前提、重複、削除候補、修正方向を評価する |
| 書き続ける伴走者 | フリーライティングの勢い、発見、固有の表現、続ける価値のある部分を積極的に支える |
