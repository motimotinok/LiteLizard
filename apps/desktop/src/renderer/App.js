...
export function App() {
    const { rootPath, tree, currentFilePath, document: currentDocument, dirty, editorMode, viewScale, openFolder, createDocument, createEntry, renameEntry, deleteEntry, loadDocument, reorderParagraphs, reorderChapters, syncDocumentStructure, saveNow, cycleEditorMode, setViewScale, bootstrapApiKeyStatus, } = useAppStore();
    ...
    return (_jsxs("div", { className: "workspace-root", children: [_jsxs("header", { className: "global-header", children: [_jsx("div", { className: "global-header-left", children: _jsx("button", { className: explorerOpen ? 'panel-toggle is-active' : 'panel-toggle', onClick: () => setExplorerOpen((v) => !v), title: "\u30A8\u30AF\u30B9\u30D7\u30ED\u30FC\u30E9\u30FC", children: _jsx(DoorIcon, {}) }) }), _jsx("div", { className: "global-header-center", children: currentDocument ? (_jsx("div", { className: "global-tab", children: currentDocument.title })) : null }), _jsx("div", { className: "global-header-right", children: _jsx("button", { className: chatPanelOpen ? 'panel-toggle is-active' : 'panel-toggle', onClick: () => setChatPanelOpen((current) => !current), title: "\u30C1\u30E3\u30C3\u30C8 (Cmd/Ctrl+Shift+A)", children: _jsx(DoorIcon, {}) }) })] }), _jsxs("div", { className: "workspace-body", children: [_jsxs("div", { className: "workspace-left", children: [_jsx(LeftIconRail, {}), explorerOpen && (_jsx(ExplorerPane, { rootPath: rootPath, tree: tree, currentFilePath: currentFilePath, style: { width: explorerPanel.width }, onCreateEntry: (parentPath, type, name) => void createEntry(parentPath, type, name), onRenameEntry: (targetPath, nextName) => void renameEntry(targetPath, nextName), onDeleteEntry: (targetPath) => void deleteEntry(targetPath), onSelectFile: (path) => void loadDocument(path) })), explorerOpen && (_jsx("div", { className: "panel-resizer", onMouseDown: (e) => explorerPanel.onMouseDown(e, 1) }))] }), _jsxs("main", { className: "workspace-main", children: [_jsxs("div", { className: chatPanelOpen ? 'workspace-content with-chat' : 'workspace-content no-chat', children: [_jsx(EditorPane, { isExpanded: !chatPanelOpen, document: currentDocument, dirty: dirty, activeParagraphId: activeParagraphId, scrollRequest: scrollRequest, setActiveParagraphId: setActiveParagraphId, viewScale: viewScale, onSetViewScale: setViewScale, onSyncStructure: (input) => syncDocumentStructure(input), onReorderParagraphs: (orderedIds) => reorderParagraphs(orderedIds), onReorderChapters: (orderedIds) => reorderChapters(orderedIds), onCreateEssay: () => {
                                            if (!rootPath) {
                                                void openFolder();
                                                return;
                                            }
                                            void createDocument('Untitled', rootPath);
                                        }, onOpenFolder: () => void openFolder() }), chatPanelOpen ? (_jsxs("aside", { className: "chat-shell", style: { width: chatPanel.width }, "aria-label": "chat-panel", children: [_jsx("div", { className: "panel-resizer panel-resizer-left", onMouseDown: (e) => chatPanel.onMouseDown(e, -1) }), _jsx("div", { className: "chat-body", children: _jsx(AnalysisPane, { document: currentDocument, activeParagraphId: activeParagraphId, onSetActiveParagraphId: setActiveParagraphId, onReorderParagraphs: (orderedIds) => reorderParagraphs(orderedIds), onRequestScrollToParagraph: (paragraphId) => {
