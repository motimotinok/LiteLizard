...
このコマンドは現在、ローカル確認用に `apps/desktop/release/mac-arm64/LiteLizard.app` を生成します。MVP 公開では GitHub Releases に未署名の macOS `.dmg` を置く方針ですが、Developer ID 署名、notarization、自動更新は MVP 後の対応です。
